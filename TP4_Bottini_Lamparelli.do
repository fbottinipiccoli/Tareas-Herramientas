 ...
 *mapa:
grmap thefts_per using coord_ls, id(id) clmethod(q) cln(6) title("Robos (cada 1000 habitantes)") legend(size(small) position(5) xoffset(17.5)) fcolor(Purples) plotregion(margin(b+15)) ndfcolor(gray) name(g2,replace) note("Mapa de Londres")  
